        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="alert alert-info d-flex align-items-center" role="alert">
                    ...
                    <div>
                        <strong>Edit Pelanggaran:</strong> {{ $pelanggaran->siswa->nama }} - {{ $pelanggaran->jenis_pelanggaran }}
                        <br>
                        <small>Dicatat pada: {{ $pelanggaran->tanggal_format }}</small>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header bg-gradient-warning">
                        <h5 class="mb-0 text-white">
                            <i class="fas fa-edit me-2"></i>Form Edit Pelanggaran
                        </h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('guru.pelanggaran.update', $pelanggaran->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="jenis_pelanggaran" id="jenis_pelanggaran"
                                            ...
                                            list="jenisPelanggaranList" required>
                                        <button class="btn btn-outline-secondary" type="button"
                                            data-bs-toggle="modal" data-bs-target="#jenisPelanggaranModal">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="kategori" id="kategori"
                                        ...
                                        <option value="Ringan" {{ old('kategori', $pelanggaran->kategori) == 'Ringan' ? 'selected' : '' }}>
                                            Ringan
                                        </option>
                                        <option value="Sedang" {{ old('kategori', $pelanggaran->kategori) == 'Sedang' ? 'selected' : '' }}>
                                            Sedang
                                        </option>
                                        <option value="Berat" {{ old('kategori', $pelanggaran->kategori) == 'Berat' ? 'selected' : '' }}>
                                            Berat
                                        </option>
                                    </select>
                                    @error('kategori')
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="keterangan" id="keterangan" rows="4"
                                        ...
                                        placeholder="Keterangan tambahan (opsional)...">{{ old('keterangan', $pelanggaran->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                ...
                                <button type="submit" class="btn btn-warning">
                                    <i class="fas fa-save me-1"></i> Update Pelanggaran
                                </button>
                            </div>
                        </form>
                    </div>
