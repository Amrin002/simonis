...
@section('section')
    <div class="content-wrapper">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="page-title">
                            <i class="fas fa-clipboard-check me-2"></i>Input Absensi {{ $mapel->nama_matapelajaran }}
                        </h1>
                        <p class="text-muted mb-0">
                            <i class="fas fa-info-circle me-1"></i> Input absensi {{ $mapel->nama_matapelajaran }} untuk kelas {{ $kelas->nama }}
                        </p>
                    </div>
                    <div>
                        <a href="{{ route('guru.absensi.select-kelas-mapel') }}" class="btn btn-secondary">
                    ...
                    <div class="alert alert-warning border-0 shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Sudah ada absensi {{ $mapel->nama_matapelajaran }} untuk kelas ini pada tanggal hari ini. Silakan edit absensi yang sudah ada atau pilih tanggal lain.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="info-box">
                                    <small class="text-muted d-block">Kode Mapel</small>
                                    <strong class="text-success">{{ $mapel->kode }}</strong>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="info-box">
                            ...
                            <div class="col-md-3">
                                <div class="info-box">
                                    ...
                                    <strong class="text-warning">
                                        <i class="fas fa-users me-1"></i>{{ $siswas->count() }} Siswa
                                    </strong>
                                </div>
                            </div>
                        </div>
        ...
        {{-- Form Input Absensi --}}
        <form action="{{ route('guru.absensi.store-guru-mapel') }}" method="POST" id="formAbsensi">
            @csrf
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <small class="text-muted">
                                        ...
                                        Absensi {{ $mapel->nama_matapelajaran }} untuk kelas {{ $kelas->nama }}
                                    </small>
                                </div>
                            </div>
