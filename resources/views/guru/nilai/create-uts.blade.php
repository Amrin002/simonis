...
@section('section')
    <div class="content-wrapper">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="page-title">
                            <i class="fas fa-file-alt me-2"></i>Input Nilai UTS
                        </h1>
            ...
            <div class="col-md-12">
                @if($existingNilai->count() > 0)
                    <div class="alert alert-warning" role="alert">
                        ...
                        <strong>Perhatian!</strong> Beberapa siswa sudah memiliki nilai UTS.
                        Jika Anda mengisi ulang, nilai lama akan diupdate dengan nilai baru.
                    </div>
                @else
                    <div class="alert alert-info" role="alert">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong>Petunjuk:</strong> Masukkan nilai UTS untuk semua siswa (0-100).
                        Nilai akan otomatis dihitung untuk nilai akhir jika Tugas dan UAS sudah diinput.
                    </div>
                @endif
            </div>
        </div>
        ...
        {{-- Form Input Nilai --}}
        <form action="{{ route('guru.nilai.uts.store') }}" method="POST" id="formNilai">
            @csrf
                                ...
                                <table class="table table-hover align-middle">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th width="20%">Nilai UTS (0-100)</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="nilai_uts[{{ $siswa->id }}]"
                                                        ...
                                                        value="{{ $existing ? $existing->nilai_uts : '' }}" placeholder="0-100"
                                                        required>
                                                    @error("nilai_uts.{$siswa->id}")
    ...
    <script>
        ...
        document.getElementById('formNilai').addEventListener('submit', function (e) {
            ...
            if (!isValid) {
                ...
                if (!confirm('Apakah Anda yakin ingin menyimpan semua nilai UTS?')) {
                    e.preventDefault();
                }
            }
        });
