        ...
        <div class="card card-custom mb-3">
            ...
            <div class="card-body">
                <div class="alert alert-info mb-4">
                    ...
                    <strong>Catatan:</strong> Ini adalah data master guru. Akun login dapat dibuat nanti melalui menu Kelola User.
                </div>
                        ...
                        <div class="card border-success mb-3">
                            <div class="card-body">
                                ...
                                <div id="kelas_section" style="display: none;">
                                    ...
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Pilih kelas yang akan diampu sebagai wali kelas</small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="mapel_section" style="display: none;">
                                    ...
                                    <div class="border rounded p-3" style="max-height: 200px; overflow-y: auto;">
                                        ...
                                        @empty
                                        <p class="text-muted mb-0">Tidak ada mata pelajaran tersedia</p>
                                        @endforelse
                                    </div>
                                    @error('mapel_ids')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Pilih satu atau lebih mata pelajaran</small>
                                </div>
                            </div>
                        </div>
                    </div>
