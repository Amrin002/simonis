            ...
            <div class="card card-custom mb-3">
                ...
                <div class="card-body">
                    <div class="alert alert-info mb-4">
                        ...
                        <strong>Catatan:</strong> Data orang tua wajib diisi. Kelas bersifat opsional dan dapat diatur
                        kemudian.
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                        name="nama" value="{{ old('nama') }}" placeholder="Masukkan nama lengkap siswa"
                                        required>
                                </div>
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('nis') is-invalid @enderror" id="nis"
                                        name="nis" value="{{ old('nis') }}" placeholder="Contoh: 2024001" required>
                                </div>
                                @error('nis')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('orang_tua_id') is-invalid @enderror" id="orang_tua_id"
                                    ...
                                    @empty
                                        <option value="" disabled>Tidak ada orang tua tersedia</option>
                                    @endforelse
                                </select>
                                @error('orang_tua_id')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                ...
                                @if($orangtuas->count() == 0)
                                    <small class="text-danger">
                                        ...
                                        <a href="{{ route('admin.orangtua.create') }}" target="_blank">Tambah orang tua</a>
                                    </small>
                                @else
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('kelas_id') is-invalid @enderror" id="kelas_id"
                                    name="kelas_id">
                                    <option value="">-- Pilih Kelas (Bisa nanti) --</option>
                                ...
                                @error('kelas_id')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Kelas dapat diisi kemudian</small>
                            </div>
                        </div>
                    </div>
                </div>
