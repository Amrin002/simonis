...
@section('section')
    <div class="content-wrapper">
        <div class="row mb-3">
            <div class="col-md-12">
                <h1 class="page-title">Edit Data Kelas</h1>
                ...
                <div class="card-body">
                    @if($kelas->siswas->count() > 0)
                        <div class="alert alert-info mb-4">
                            ...
                            Kelas ini memiliki <strong>{{ $kelas->siswas->count() }} siswa</strong> terdaftar.
                        </div>
                    @endif
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                        name="nama" value="{{ old('nama', $kelas->nama) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('wali_guru_id') is-invalid @enderror" id="wali_guru_id"
                                    ...
                                    @foreach($guruTersedia as $guru)
                                        <option value="{{ $guru->id }}" {{ old('wali_guru_id', $kelas->wali_guru_id) == $guru->id ? 'selected' : '' }}>
                                ...
                                @if($kelas->waliKelas)
                                    <small class="text-info">
                                        ...
                                        <strong>{{ $kelas->waliKelas->nama_guru }}</strong>
                                    </small>
                                @else
                                    <small class="text-warning">
                                        <i class="fas fa-exclamation-triangle"></i> Belum ada wali kelas
                                    </small>
                                @endif
                            </div>
                        </div>
