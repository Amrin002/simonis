                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_matapelajaran', $mapel->nama_matapelajaran) }}"
                ...
                <div class="card-body">
                    @if($mapel->gurus->count() > 0)
                        <div class="alert alert-info mb-3">
                            ...
                            Saat ini ada <strong>{{ $mapel->gurus->count() }} guru</strong> mengampu mata pelajaran ini
                        </div>
                    @endif
                        ...
                        @foreach($gurus as $guru)
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="guru_ids[]" value="{{ $guru->id }}"
                                    id="guru_{{ $guru->id }}" {{ in_array($guru->id, old('guru_ids', $mapel->gurus->pluck('id')->toArray())) ? 'checked' : '' }}>
                    ...
                    <small class="text-muted d-block mt-2">
                        Perubahan akan otomatis mengupdate tabel GuruMapel (tambah/hapus relasi)
                    </small>
                </div>
            </div>
